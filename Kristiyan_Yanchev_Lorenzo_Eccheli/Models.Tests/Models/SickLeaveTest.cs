...
namespace Data.Test.Models
{
    ...
    public class SickLeaveTest
    {
        ...
        public void Constructor_StartDateBefore1900_ThrowsArgumentException()
        {
            ...
            Assert.Throws<ArgumentException>(() => { var leave = new SickLeave(new DateTime(1899, 1, 1), DateTime.Now, teacher); });
        }
        ...
        public void Constructor_EndDateBefore1900_ThrowsArgumentException()
        {
            ...
            Assert.Throws<ArgumentException>(() => { var leave = new SickLeave(new DateTime(1900, 1, 1), new DateTime(1900, 1, 1), teacher); });
        }
        ...
        public void Constructor_EndDateBeforeStartDate_ThrowsArgumentException(DateTime startDate, DateTime endDate)
        {
            ...
            Assert.Throws<ArgumentException>(() => { var leave = new SickLeave(startDate, endDate, teacher); });
        }
    }
}
